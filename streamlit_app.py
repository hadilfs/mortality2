...
if selectedchart == "Bar Chart":
    ...
    st.caption("***Checking on the 'Highlight Highest Value' box allows you to observe the bar which refers to the highest death rate in the year range you chose. Notably, the bar chart shows that in the year 1976 there was a sudden increase in the death rate which could be explained by the fact that in this year, the Lebanese Civil War was at its climax. Additionally, in 1982 the Israel Defense forces invaded the country in the midst of the War, which explain the second increase in that year. Also, a gradual increase is observed between the years 2019 and 2021 due to the COVID-19 pandemic.***")
    if highest_value:
